...
#ifndef GRPC_distributionSystemService_2eproto__INCLUDED
#define GRPC_distributionSystemService_2eproto__INCLUDED
...
class DistributionSystemService final {
 public:
  static constexpr char const* service_full_name() {
    return "distributionSystemService.DistributionSystemService";
  }
  class StubInterface {
   public:
    virtual ~StubInterface() {}
    virtual ::grpc::Status Ping(::grpc::ClientContext* context, const ::distributionSystemService::Empty& request, ::distributionSystemService::PingResponse* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::distributionSystemService::PingResponse>> AsyncPing(::grpc::ClientContext* context, const ::distributionSystemService::Empty& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::distributionSystemService::PingResponse>>(AsyncPingRaw(context, request, cq));
    }
  ...
  class Stub final : public StubInterface {
   public:
    ...
    ::grpc::Status Ping(::grpc::ClientContext* context, const ::distributionSystemService::Empty& request, ::distributionSystemService::PingResponse* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::distributionSystemService::PingResponse>> AsyncPing(::grpc::ClientContext* context, const ::distributionSystemService::Empty& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::distributionSystemService::PingResponse>>(AsyncPingRaw(context, request, cq));
    }
  ...
  class WithAsyncMethod_Ping : public BaseClass {
   ...
   public:
    ...
    void RequestPing(::grpc::ServerContext* context, ::distributionSystemService::Empty* request, ::grpc::ServerAsyncResponseWriter< ::distributionSystemService::PingResponse>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
   ...
   public:
    WithCallbackMethod_Ping() {
      ::grpc::Service::MarkMethodCallback(0,
          new ::grpc::internal::CallbackUnaryHandler< ::distributionSystemService::Empty, ::distributionSystemService::PingResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::distributionSystemService::Empty* request, ::distributionSystemService::PingResponse* response) { return this->Ping(context, request, response); }));}
    void SetMessageAllocatorFor_Ping(
        ::grpc::MessageAllocator< ::distributionSystemService::Empty, ::distributionSystemService::PingResponse>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(0);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::distributionSystemService::Empty, ::distributionSystemService::PingResponse>*>(handler)
    ...
    WithStreamedUnaryMethod_Ping() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::internal::StreamedUnaryHandler<
          ::distributionSystemService::Empty, ::distributionSystemService::PingResponse>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerUnaryStreamer<
                     ::distributionSystemService::Empty, ::distributionSystemService::PingResponse>* streamer) {
...
#endif  // GRPC_distributionSystemService_2eproto__INCLUDED
